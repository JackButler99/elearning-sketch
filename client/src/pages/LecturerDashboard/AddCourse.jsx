...
const AddCourse = ({isShowing, onClose, setCourseCreated}) => {
  ...
  <>
    <div className='flex flex-col'>
      ...
      <form className='pl-4 font-semibold'>
        <h3>Course Name:</h3>
        <input type='text' name='title' onChange={handleChangeTitle} className={`w-[450px] h-[40px] px-2 border-2 ${!isTitleValid? 'border-red-300':'border-green-300'} ` } placeholder='Course Title'></input>
        {!isTitleValid? (
        ...
        <textarea name='desc' onChange={handleChangeDesc} className={`w-[450px] h-[80px] px-2 border-2 border-gray-300 ${!isDescValid? 'border-red-300':'border-green-300'}`} placeholder='Course Description'></textarea>
        {!isDescValid? (
          <div className='text-red-500 text-xs'>
